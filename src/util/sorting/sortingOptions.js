...
export const sortingOptions = [
    { value: CREATED_TIME_ASC, label: 'Created Time a-z' },
    { value: CREATED_TIME_DESC, label: 'Created Time z-a' },
    { value: TITLE_ASC, label: 'Title a-z' },
    { value: TITLE_DESC, label: 'Title z-a' },
    { value: IS_DONE_ASC, label: 'Done last' },
    { value: IS_DONE_DESC, label: 'Done first' },
];
